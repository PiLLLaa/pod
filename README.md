...
![header](https://capsule-render.vercel.app/api?type=Waving&color=gradient&text=%20PiLLLaDCPODfilter%20%20&height=300&fontSize=80)
...
## :purple_heart:         Recommended Automatic download on the launcher that files named as "item.filter"           :purple_heart:
##Update list
 ----------------------------------------------------------------------------------------------------------------------
     1. 13.Mar,2024
...
----------------------------------------------------------------------------------------------------------------------
     5. 15.Mar,2024
      1) Expression change of Unidenfied Uniq items
      2) Filter bugs fixed
         - Hellfire torch drop error when choose filter level "large charm deletion"
...
----------------------------------------------------------------------------------------------------------------------
     10. 16.Sep,2024
      1) Added Orb of  Alteration
      2) Tier level change for Maps
      3) Stopping information resi of maps
...
----------------------------------------------------------------------------------------------------------------------
     23. 16.Dec,2024
      1) Filter Level Change (SET item deletion change to Strict mode)
         -. Rare be disabled except for Gloves/Boots/Circlets/Throwing/Nec Sheild/Claws/Staves
...
![image](https://user-images.githubusercontent.com/76995697/116763307-5384fb00-aa58-11eb-986b-db564ab461f3.png)
